...
public static class ActionSystemDefaults
{
    ...
    public static List<ActionGroupConfig> BuildActionGroups()
    {
        ...
        groups.Add(Group("Idle", "plain", 1f, "Idle", true, true));
        groups.Add(Group("Touch", "", 1f, "Touch", false, false));
        groups.Add(Group("Drag", "", 1f, "Drag", false, false));
        groups.Add(Group("Speak Normal", "", 1f, "Speak Normal", true, false));
        groups.Add(Group("Speak Explain", "serious", 1f, "Speak Explain", true, false));
        groups.Add(Group("Speak Excited", "fun", 1f, "Speak Excited", true, false));
        groups.Add(Group("Speak Thinking", "thinking", 1f, "Speak Thinking", true, false));
        groups.Add(Group("Speak Chatty", "angry", 1f, "Speak Chatty", true, false));
        groups.Add(Group("Speak Shy", "shy", 1f, "Speak Shy", true, false));
        groups.Add(Group("Wave Hands", "", 1f, "Wave Hands", false, false));
        groups.Add(Group("Cat", "wink", 1f, "Cat", false, false));
        groups.Add(Group("Doya", "confident", 1f, "Doya", false, false));
        groups.Add(Group("Welcome", "fun", 1f, "Welcome", false, false));
        groups.Add(Group("Yay", "happy", 1f, "Yay", false, false));
        groups.Add(Group("Shy", "shy", 1f, "Shy", false, false));
        groups.Add(Group("Comfort", "fun", 1f, "Comfort", false, false));
        groups.Add(Group("Highfive", "fun", 1f, "Highfive", false, false));
        groups.Add(Group("Deny", "serious", 1f, "Deny", false, false));
        groups.Add(Group("Determine", "serious", 1f, "Determine", false, false));
        groups.Add(Group("Cute", "wink", 1f, "Cute", false, false));
        groups.Add(Group("Invite Give", "fun", 1f, "Invite Give", false, false));
        groups.Add(Group("Disagree", "thinking", 1f, "Disagree", false, false));
        groups.Add(Group("Confuse", "curious", 1f, "Confuse", false, false));
        groups.Add(Group("Agree", "fun", 1f, "Agree", false, false));
        groups.Add(Group("Think", "thinking", 1f, "Think", false, false));
        groups.Add(Group("Sleepy", "thinking", 1f, "Sleepy", false, false));
        groups.Add(Group("Expectation", "fun", 1f, "Expectation", false, false));
        groups.Add(Group("Angry", "angry", 1f, "Angry", false, false));
        groups.Add(Group("Hurry", "angry", 1f, "Hurry", false, false));
        groups.Add(Group("Focused", "curious", 1f, "Focused", false, false));
        groups.Add(Group("Afraid", "sweating", 1f, "Afraid", false, false));
        groups.Add(Group("Apologize", "sweating", 1f, "Apologize", false, false));
