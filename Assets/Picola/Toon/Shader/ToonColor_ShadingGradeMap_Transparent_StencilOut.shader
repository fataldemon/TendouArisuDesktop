...
Shader "UnityChanToonShader/NoOutline/ToonColor_ShadingGradeMap_Transparent_StencilOut" {
    Properties {
...
//v.2.0.4 HighColor_Tex
        ...
        [HideInInspector] _Is_UseTweakHighColorOnShadow ("Is_UseTweakHighColorOnShadow", Float ) = 0
        [HideInInspector] _TweakHighColorOnShadow ("TweakHighColorOnShadow", Range(0, 1)) = 0
//ハイカラーマスク.
...
//ここまで.
        ...
        [HideInInspector] _Is_UseTweakMatCapOnShadow ("Is_UseTweakMatCapOnShadow", Float ) = 0
        [HideInInspector] _TweakMatCapOnShadow ("TweakMatCapOnShadow", Range(0, 1)) = 0
//MatcapMask
...
//GI
    ...
    SubShader {
        ...
        //"UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD"
        Pass {
            Name "FORWARD"
            Tags {
        ...
        //UsePass "UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD"
        //UsePass "UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/FORWARD_DELTA"
        //UsePass "UnityChanToonShader/Toon_ShadingGradeMap_TransClipping/SHADOWCASTER"
    }
