...
Shader "UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather_Clipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilOut/FORWARD"
        UsePass "UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanToonShader/Toon_DoubleShadeWithFeather_Clipping_StencilOut/SHADOWCASTER"
    }
