...
Shader "UnityChanToonShader/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Toon_ShadingGradeMap_TransClipping_StencilMask/FORWARD_DELTA"
