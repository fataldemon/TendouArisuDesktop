...
Shader "UnityChanToonShader/NoOutline/ToonColor_ShadingGradeMap_TransClipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Toon_ShadingGradeMap_TransClipping_StencilOut/FORWARD"
        UsePass "UnityChanToonShader/Toon_ShadingGradeMap_TransClipping_StencilOut/FORWARD_DELTA"
