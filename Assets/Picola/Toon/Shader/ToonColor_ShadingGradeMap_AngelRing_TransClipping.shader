...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/AngelRing/Toon_ShadingGradeMap_TransClipping/FORWARD"
        UsePass "UnityChanToonShader/AngelRing/Toon_ShadingGradeMap_TransClipping/FORWARD_DELTA"
