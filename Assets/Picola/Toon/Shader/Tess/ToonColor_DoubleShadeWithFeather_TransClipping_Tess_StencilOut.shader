...
Shader "UnityChanToonShader/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather_TransClipping_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD"
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping_StencilOut/SHADOWCASTER"
    }
