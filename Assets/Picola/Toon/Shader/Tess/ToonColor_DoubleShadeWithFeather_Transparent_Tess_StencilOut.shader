...
Shader "UnityChanToonShader/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather_Transparent_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        //"UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_TransClipping/FORWARD"
        Pass {
            Name "FORWARD"
            Tags {
