...
Shader "UnityChanToonShader/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/FORWARD"
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/FORWARD_DELTA"
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/SHADOWCASTER"
