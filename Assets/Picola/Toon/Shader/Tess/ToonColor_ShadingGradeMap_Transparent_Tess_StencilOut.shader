...
Shader "UnityChanToonShader/Tessellation/NoOutline/ToonColor_ShadingGradeMap_Transparent_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        //"UnityChanToonShader/Tessellation/Toon_ShadingGradeMap_TransClipping/FORWARD"
        Pass {
            Name "FORWARD"
            Tags {
