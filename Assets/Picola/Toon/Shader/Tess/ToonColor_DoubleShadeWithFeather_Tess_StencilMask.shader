...
Shader "UnityChanToonShader/Tessellation/NoOutline/ToonColor_DoubleShadeWithFeather_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilMask/FORWARD_DELTA"
