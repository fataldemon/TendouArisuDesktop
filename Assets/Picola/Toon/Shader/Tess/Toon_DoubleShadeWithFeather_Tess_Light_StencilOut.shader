...
Shader "UnityChanToonShader/Tessellation/Light/Toon_DoubleShadeWithFeather_StencilOut" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Tessellation/Toon_DoubleShadeWithFeather_StencilOut/OUTLINE"
