...
Shader "UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather_Transparent_StencilOut" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        //"UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping/FORWARD"
        Pass {
            Name "FORWARD"
            Tags {
