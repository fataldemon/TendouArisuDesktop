...
Shader "UnityChanToonShader/Mobile/Toon_DoubleShadeWithFeather_TransClipping_StencilMask" {
    Properties {
...
//Outline
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Toon_DoubleShadeWithFeather_TransClipping_StencilMask/OUTLINE"
