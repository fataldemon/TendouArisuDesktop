...
Shader "UnityChanToonShader/NoOutline/ToonColor_DoubleShadeWithFeather_StencilMask" {
    Properties {
...
//GI
    ...
    SubShader {
        ...
        UsePass "UnityChanToonShader/Toon_DoubleShadeWithFeather_StencilMask/FORWARD_DELTA"
